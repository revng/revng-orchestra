...
def test_ls_remote_with_local_clone(orchestra: OrchestraShim):
    """Checks that orchestra correctly reads the current branch name and commit hash
    when there is a local clone of the sources"""
...
def test_ls_remote_without_local_clone(orchestra: OrchestraShim):
    """Checks that orchestra correctly reads the current branch name and commit hash
    when there is not a local clone of the sources"""
    orchestra("update")

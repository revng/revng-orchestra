...
build_group.add_argument(
    "--fallback-build", "-b", action="store_true", help="Build if binary archives are not available"
)
...
execution_group.add_argument(
    "--pretend", "-n", action="store_true", help="Do not execute actions, only print what would be done"
)

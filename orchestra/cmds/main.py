...
logging_group.add_argument(
    "--loglevel", "-v", default="INFO", choices=["DEBUG", "INFO", "WARNING", "ERROR", "CRITICAL"]
)
...
config_group.add_argument("--orchestra-dir", "-C", help="Behave as if orchestra was launched in this directory")

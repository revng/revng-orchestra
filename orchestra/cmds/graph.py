...
def install_subcommand(sub_argparser):
    ...
    cmd_parser.add_argument("--no-remove-unreachable", action="store_true", help="Don't remove unreachable actions")
    cmd_parser.add_argument("--no-simplify-anyof", action="store_true", help="Don't remove choices")
    cmd_parser.add_argument("--no-remove-satisfied-leaves", action="store_true", help="Don't remove satisfied leaves")
    cmd_parser.add_argument("--no-transitive-reduction", action="store_true", help="Don't perform transitive reduction")
